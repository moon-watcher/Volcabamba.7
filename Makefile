...
DEFAULT_FLAGS = -m68000 -Wall -Wextra -Wno-shift-negative-value -Wno-main -Wno-unused-parameter -Wno-unused-but-set-variable -Wno-unused-variable -Wno-unused-function -Wno-unused-value -Wno-implicit-function-declaration -Wno-missing-field-initializers -fno-builtin $(INCS) -B$(BIN) 
...
out/rom.bin: out/rom.out
	$(OBJCPY) -O binary out/rom.out $(PROJECT)
	$(SIZEBND) $(PROJECT) -sizealign 131072
